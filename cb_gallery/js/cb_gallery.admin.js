...
$(function () { // On Document Ready
  ...
  function resetEditFormFields() {
    ...
    $('#node-form .input_image_name, #node-form .input_image_caption, .input_image_transcript, #node-form .input_thumbnail_path, #edit-edit-media-id').val('');
  ...
  function populateForm(data) {
	...
	$('.input_media_transcript').val(data.media_transcript); // set the transcript
  ...
  function front_end_validation_live(){
  ...
  function front_end_validation_submit(){
    var edit_media_type_video = $('#edit-media-type-video');
	var edit_video_embed_code = $('#edit-video-embed-code');
	if(edit_media_type_video.attr('checked', 'checked') && edit_video_embed_code.val() == ''){
	  alert('Video Embed Code field is required.');
	}
  }
   ...
   * JH - 'stop:function(){}' won't work. We have to bind it for some reason...
   * with the DOM.
   */
  function resetEventBindings() {
    //Implementation of jQuery Sortable()
